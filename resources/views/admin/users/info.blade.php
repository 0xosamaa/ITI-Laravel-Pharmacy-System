    ...
    <table class="table table-striped-columns">
        <tbody>
            ...
            <tr class="">
                ...
                <td scope="row">
                    {{ $user->date_of_birth }}
                    @if(($user->date_of_birth)==null)  <small class="text-warning">Not Added Yet</small>  @endif
                </td>
            </tr>
            <tr class="">
                <th>Mobile Number</th>
                <td scope="row">
                    {{ $user->mobile_number }}
                    @if(($user->mobile_number)==null)  <small class="text-warning">Not Added Yet</small>  @endif
                </td>
            </tr>
            <tr class="">
                <th>National ID</th>
                <td scope="row">
                    {{ $user->national_id }}
                    @if(($user->national_id)==null)  <small class="text-warning">Not Added Yet</small>  @endif
                </td>
            </tr>
            <tr class="">
                <th>Created At</th>
            ...
            <tr class="">
                <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-icon btn-light text-info rounded-pill m-2  shadow bg-body-tertiary">
