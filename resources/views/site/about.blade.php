...
@endsection
@section('content')
    <div class="site-blocks-cover inner-page" style="background-image: url('{{ asset('site/images/hero_1.jpg') }}');">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="{{ asset('site/images/bg_1.jpg') }}" alt="Image placeholder"
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6 order-md-2">
                    <div class="block-16">
                        <figure>
                            <img src="{{ asset('site/images/hero_1.jpg') }}" alt="Image placeholder"
                                class="img-fluid rounded">
                            <a href="https://vimeo.com/channels/staffpicks/93951774" class="play-button popup-vimeo"><span
                                    class="icon-play"></span></a>
            ...
            <div class="row">
                    ...
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('site/images/person_1.jpg') }}" alt="Image placeholder" class="mb-4">
                ...
                <div class="col-md-6 col-lg-6 mb-5">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('site/images/person_2.jpg') }}" alt="Image placeholder" class="mb-4">
                ...
                <div class="col-md-6 col-lg-6 mb-5">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('site/images/person_3.jpg') }}" alt="Image placeholder" class="mb-4">
                ...
                <div class="col-md-6 col-lg-6 mb-5">
                    <div class="block-38 text-center">
                        <div class="block-38-img">
                            <div class="block-38-header">
                                <img src="{{ asset('site/images/person_4.jpg') }}" alt="Image placeholder"
                                    class="mb-4">
